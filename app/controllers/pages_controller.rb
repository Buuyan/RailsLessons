    ...
    def search
        ...
        if params[:q].present?
            ...
            if params[:q][:price_pernight_gteq].present?
              session[:price_pernight_gteq] = params[:q][:price_pernight_lteq]
            else
        ...
        session[:q] = {"price_pernight_gteq" => session[:price_pernight_gteq], "price_peright_lteq" => session[:price_pernight_lteq],
        ...
        # start_date end_date の間に予約がないことを確認して、あれば削除
